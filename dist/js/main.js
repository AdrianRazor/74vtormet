...
var listItem = document.querySelectorAll('.table__item');
var tabBlock = document.querySelectorAll('.table__tab');
var nav = document.querySelector('.table__nav');
var arrow = document.querySelector('.table__arrow');
